...
import unittest
import pytest
class Test_version3_Na3SbS4(unittest.TestCase):
    ...
    def test_generate_local_cluster_exapnsion(self):
        ...
        a.initialization3(mobile_ion_identifier_type=mobile_ion_identifier_type,mobile_ion_specie_1_identifier=mobile_ion_specie_1_identifier,cutoff_cluster=[6,6,0],cutoff_region=5,template_cif_fname="Na3SbS4_cubic.cif",convert_to_primitive_cell=True,is_write_basis=True,species_to_be_removed=["S2-","S"])
