...
class Test_version3(unittest.TestCase):
    ...
    def test_fitting(self):
        ...
        y_pred, y_true = local_cluster_expansion_fit.fit(
            alpha=1.5,
            max_iter=1000000,
            ekra_fname="fitting/local_cluster_expansion/e_kra.txt",
            keci_fname="keci.txt",
            weight_fname="fitting/local_cluster_expansion/weight.txt",
            corr_fname="fitting/local_cluster_expansion/correlation_matrix.txt",
    ...
    def test_gather_mc_data(self):
        ...
        structure_from_json = generate_supercell(
            "./gather_mc_data/prim.json", (8, 8, 8)
        )
