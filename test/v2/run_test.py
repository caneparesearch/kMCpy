...
class TestStringMethods(unittest.TestCase):
    ...
    # event kernal
    generate_events2(prim_cif_name="./input/EntryWithCollCode15546_Na4Zr2Si3O12_573K.cif",convert_to_primitive_cell=convert_to_primitive_cell,supercell_shape=[2,1,1],local_env_cutoff_dict = {('Na+','Na+'):4,('Na+','Si4+'):4},event_fname="input/events.json",event_kernal_fname='input/event_kernal.csv',mobile_ion_specie_1_index_label_or_indices="Na1",species_to_be_removed=['Zr4+','O2-','O','Zr'],mobile_ion_specie_2_index_atom_label="Na2",verbose=True,hacking_arg={1: [18, 20, 19, 22, 21, 23, 108, 110, 109, 112, 111, 113]})
