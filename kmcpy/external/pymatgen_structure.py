...
class IStructure(SiteCollection, MSONable):
    ...
    def get_sites_in_sphere(
        ...
        Returns:
            [:class:`kmcpy.external.pymatgen_structure.PeriodicNeighbor`]
        """
    ...
    def to(self, fmt: str = None, filename=None, **kwargs) -> Optional[str]:
        ...
        if fmt == "cif" or fnmatch(fname.lower(), "*.cif*"):
            from kmcpy.external.pymatgen_cif import CifWriter
    ...
    def from_str(
        ...
        fmt_low = fmt.lower()
        if fmt_low == "cif":
            from kmcpy.external.pymatgen_cif import CifParser
    ...
    @classmethod
    def from_cif(cls,filename,primitive=False,sort=False,merge_tol=0.0):
...
class IMolecule(SiteCollection, MSONable):
    ...
    def get_sites_in_sphere(self, pt: ArrayLike, r: float) -> List[Neighbor]:
        ...
        Returns:
            [:class:`kmcpy.external.pymatgen_structure.Neighbor`]
        """
        neighbors = []
